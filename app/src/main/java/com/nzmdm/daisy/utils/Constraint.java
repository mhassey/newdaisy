...
public class Constraint {
    ...
    public static final String MAIN_ACTIVITY = "com.nzmdm.daisy.activity.mainActivity.MainActivity";
    ...
    public static final String DAISY_PACKAGE = "package:com.nzmdm.daisy";
