...
public class AutoStartHelper {
    ...
    public static List<String> brands = Arrays.asList("xiaomi", "poco", "letv", "asus", "honor", "oppo", "vivo", "nokia");
    ...
    private void showAlert(Context context, DialogInterface.OnClickListener onClickListener) {
        ...
        new AlertDialog.Builder(context).setTitle("VZW Pricing")
                .setMessage("Please allow VZW Pricing to auto start your device.")
