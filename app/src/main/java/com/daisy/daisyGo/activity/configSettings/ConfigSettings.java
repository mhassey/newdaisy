package com.daisy.daisyGo.activity.configSettings;
...
import com.daisy.R;
import com.daisy.daisyGo.activity.apkUpdate.ApkUpdateViewModel;
import com.daisy.daisyGo.activity.base.BaseActivity;
import com.daisy.daisyGo.activity.baseUrl.BaseUrlSettings;
import com.daisy.daisyGo.activity.feedBack.FeedBackActivity;
import com.daisy.daisyGo.activity.langSupport.LangSelectionActivity;
import com.daisy.daisyGo.activity.logs.LogsMainActivity;
import com.daisy.daisyGo.activity.mainActivity.MainActivity;
import com.daisy.daisyGo.activity.refreshTimer.RefreshTimer;
...
public class ConfigSettings extends BaseActivity implements View.OnClickListener {
    ...
    /**
     * Responsibility - logoutAlert is an method to redirect page to  logout alert popup
     * Parameters - No parameter
     **/
    ...
    private void handleAPkUpdateResponse(GlobalResponse<GeneralResponse> response) {
        if (response != null) {
            ...
            if (globalResponse.isApi_status()) {
                ...
                if (apkDetails != null) {
                    if (apkDetails.getAndroidGo().getVersion() != null) {
                        if (sessionManager == null)
                            sessionManager = SessionManager.get();
                        double apkVersion = Double.parseDouble(apkDetails.getAndroidGo().getVersion());
