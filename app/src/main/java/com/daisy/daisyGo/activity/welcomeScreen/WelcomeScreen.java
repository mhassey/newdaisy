...
import com.daisy.daisyGo.activity.onBoarding.slider.slides.addScreen.AddScreenViewModel;
...
public class WelcomeScreen extends BaseActivity implements View.OnClickListener {
    ...
    private void handleKeyToUrlResponse(GlobalResponse<KeyToUrlResponse> result) {
        if (result != null) {
            if (result.getResult().isMatched_status()) {
                ...
                com.daisy.mainDaisy.utils.ValidationHelper.showToast(this, getResources().getString(R.string.mpc_key_not_correct));
            }
        } else {
            checkLoadedKey();
        }
    ...
    private void checkLoadedKey() {
        if (mBinding.keyName.getText().toString().contains(com.daisy.mainDaisy.utils.Constraint.HTTP)) {
            updateBaseUrl();
    ...
    private void handleGeneralResponse(GlobalResponse<GeneralResponse> generalResponseGlobalResponse) {
        ...
        if (generalResponseGlobalResponse != null) {
            if (generalResponseGlobalResponse.isApi_status()) {
                ...
                com.daisy.mainDaisy.utils.ValidationHelper.showToast(WelcomeScreen.this, getString(R.string.enter_valid_url));

            }
        } else {
            sessionManager.removeBaseUrl();
            com.daisy.mainDaisy.utils.ValidationHelper.showToast(this, getString(R.string.enter_valid_url));
        }
    }
    ...
    private void updateBaseUrl() {
        try {
            ...
            if (url != null && !url.equals("")) {
                ...
                if (urlLastChar.equals(com.daisy.mainDaisy.utils.Constraint.SLASH)) {
    ...
    private HashMap<String, String> createKeyToUrlRequest() {
        ...
        stringStringHashMap.put(Constraint.TOKEN, com.daisy.mainDaisy.common.session.SessionManager.get().getDeviceToken());
