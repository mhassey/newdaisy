...
public class Constraint {
    ...
    public static final String MAIN_ACTIVITY = "com.vzwmdm.daisy.activity.mainActivity.MainActivity";
    ...
    public static final String DAISY_PACKAGE = "package:com.vzwmdm.daisy";
