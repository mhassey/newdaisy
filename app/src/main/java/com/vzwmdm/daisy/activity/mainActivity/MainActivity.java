package com.vzwmdm.daisy.activity.mainActivity;
...
import com.vzwmdm.daisy.activity.apkUpdate.DownloadUpdateApk;
import com.vzwmdm.daisy.activity.base.BaseActivity;
import com.vzwmdm.daisy.activity.configSettings.ConfigSettings;
import com.vzwmdm.daisy.activity.deleteCard.DeleteCardViewModel;
import com.vzwmdm.daisy.activity.editorTool.EditorTool;
import com.vzwmdm.daisy.activity.onBoarding.slider.getCard.GetCardViewModel;
import com.vzwmdm.daisy.activity.onBoarding.slider.getCard.vo.GetCardResponse;
import com.vzwmdm.daisy.activity.updateProduct.UpdateProductViewModel;
import com.vzwmdm.daisy.common.session.SessionManager;
import com.vzwmdm.daisy.database.DBCaller;
import com.vzwmdm.daisy.databinding.ActivityMainBinding;
...
import com.vzwmdm.daisy.pojo.response.DownloadFail;
import com.vzwmdm.daisy.pojo.response.GlobalResponse;
import com.vzwmdm.daisy.pojo.response.InternetResponse;
import com.vzwmdm.daisy.pojo.response.Inversion;
import com.vzwmdm.daisy.pojo.response.PriceCard;
import com.vzwmdm.daisy.pojo.response.Pricing;
import com.vzwmdm.daisy.pojo.response.Promotion;
import com.vzwmdm.daisy.pojo.response.Promotions;
import com.vzwmdm.daisy.pojo.response.Sanitised;
import com.vzwmdm.daisy.pojo.response.SocketEvent;
import com.vzwmdm.daisy.pojo.response.UpdateCards;
import com.vzwmdm.daisy.security.Admin;
import com.vzwmdm.daisy.service.LogGenerateService;
import com.vzwmdm.daisy.utils.CheckForSDCard;
import com.vzwmdm.daisy.utils.Constraint;
import com.vzwmdm.daisy.utils.DownloadFile;
import com.vzwmdm.daisy.utils.DownloadJSFile;
import com.vzwmdm.daisy.utils.OnSwipeTouchListener;
import com.vzwmdm.daisy.utils.PermissionManager;
import com.vzwmdm.daisy.utils.SanitisedSingletonObject;
