package com.iris.common.session;
...
import com.iris.pojo.response.PriceCardMain;
import com.iris.pojo.response.Pricing;
import com.iris.pojo.response.Promotion;
import com.iris.pojo.response.ScreenPosition;
...
//    }
    ...
    public void setAppType(String go) {
        pref.setStringData(Constraint.APP_TYPE, go);
    }
